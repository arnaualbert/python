"""
- v2: Use of inheritance to avoid code repetition.
...
# -----------------------------------------------------------------------------
def from_lullaby(name: str, age: int, lullaby: str) -> SignatusSiestus:

    result: SignatusSiestus

    if lullaby == 'Duérmete niño':
        result = SignatusSiestus(name, age, 'Zzzz')

    elif lullaby == 'Megadeth':
        result = SignatusSiestus(name, age, 'Woooo!!')
...
if __name__ == "__main__":
    ...
    mari_nice:  SignatusSiestus = from_lullaby('Mari', 4, 'Duérmete niño')
    mari_heavy: SignatusSiestus = from_lullaby('Mari', 4, 'Megadeth')
